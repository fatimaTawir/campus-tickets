      ...
      <div className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-md">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button className="bg-[#002868] text-white w-full py-2.5 rounded-lg text-sm font-medium hover:bg-blue-900 mt-2">
              Log in
            </button>
            ...
            <button className="border border-gray-300 text-gray-700 w-full py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 flex items-center justify-center gap-2">
