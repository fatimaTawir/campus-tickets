        ...
        <nav className="flex-1 px-4 py-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            {(user.role === 'organizer' || user.role === 'admin') && (
              <Link href="/organizer" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-100 text-sm"><BarChart2 className="w-4 h-4" /> Organizer</Link>
            )}
          </div>
        </nav>
        ...
        <div className="p-8 max-w-3xl">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-[#002868] rounded-2xl p-6">
              ...
              <p className="text-3xl font-bold text-white mb-4">KES 3000<span className="text-sm font-normal text-blue-300">/month</span></p>
              <ul className="flex flex-col gap-2 mb-6">
